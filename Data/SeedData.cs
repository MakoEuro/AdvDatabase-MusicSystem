...
namespace AdvDatabase_MusicSystem.Models
{
    public static class SeedData
    {
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            Albums Album1 = new Albums("Super Eurobeat Vol. 85");
            ...
            Albums Album6 = new Albums("Super Eurobeat Vol. 175");
            Albums Album7 = new Albums("Super Eurobeat Vol. 101");
            ...
            Artists Artist2 = new Artists("Cherry");
            ...
            Artists Artist8 = new Artists("Jackie O'");
            ...
            Songs Song1 = new Songs("Love and Fever Tonight", 345, Album2);
            ...
            Songs Song5 = new Songs("Speedy Speed Boy", 363, Album2);
            Songs Song6 = new Songs("Shake Me Up", 337, Album2);
            Songs Song7 = new Songs("Laser Gun", 373, Album2);
            ...
            Songs Song15 = new Songs("Furious Pistol", 382, Album6);
            ...
            Playlists playlist1 = new Playlists("Eurobeat to DANCE to");
            Playlists playlist2 = new Playlists("Eurobeat to DRIVE to");
            Playlists playlist3 = new Playlists("Eurobeat to CHILL to");
